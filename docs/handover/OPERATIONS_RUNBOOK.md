...
| Model Velocity | [Ranking ML KPIs](https://docs.google.com/spreadsheets/d/1s-Q0o19dG2b5sn25kHSXlWyqJ48vt9U39Vmi6DZU6r4/edit?gid=477633216) | `Scale ML gsheet` → four df cells → **`scale_ml_actuals`** | **Auto.** QTD launch count = sum across the three tracking tabs (Ranking + Retrieval + Shopping) of launches with **>0 impact, excluding bug fixes** (also drops backtests / deprecations / undated) | Confirm new launches on 2026 tabs |
